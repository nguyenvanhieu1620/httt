...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <nav class="header__nav">
                    <ul class="header__nav__list">
                        ...
                        <li class="header__nav__item"><a href="/TuVanTuyenSinh/signup" class="header__nav__link">Đăng ký</a></li>                    </ul>
                </nav>
            </div>
        </header>
        ...
        <section class="featured-destinations">
            <div class="container">
                <h2 class="featured-destinations__title">HỌC VIỆN HÀNH CHÍNH</h2>
                <hr class="divider">
                <div class="row">
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/ThuVien.jpg" alt="Destination 1" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">THÔNG TIN - THƯ VIỆN</a></h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/QLNS.jpg" alt="Destination 2" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">QUẢN TRỊ VĂN PHÒNG</a></h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/QLVP.jpg" alt="Destination 3" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">QUẢN TRỊ NHÂN LỰC</a></h3>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="featured-destinations">
    <div class="container">
        <h2 class="featured-destinations__title">ĐẠI HỌC KINH TẾ QUỐC DÂN</h2>
        <hr class="divider">
        <div class="row">
            <div class="col-md-4">
                <div class="destination">
            ...
            <div class="col-md-4">
                <div class="destination">
                    <img src="./Asset/image/QTKD.jpg" alt="Destination 3" class="destination__image">
                    <h3 class="destination__title"><a href="#" style="color: black;text-decoration: none;">QUẢN TRỊ KINH DOANH</a></h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="destination">
                    <img src="./Asset/image/TMDT.jpg" alt="Destination 4" class="destination__image">
                    <h3 class="destination__title"><a href="#" style="color: black;text-decoration: none;">THƯƠNG MẠI ĐIỆN TỬ</a></h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="destination">
                    <img src="./Asset/image/Logistic.jpg" alt="Destination 5" class="destination__image">
                    <h3 class="destination__title"><a href="#" style="color: black;text-decoration: none;">LOGISTIC VÀ QUẢN LÝ CHUỖI CUNG ỨNG</a></h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="destination">
                    <img src="./Asset/image/QTKS.jpg" alt="Destination 6" class="destination__image">
                    <h3 class="destination__title"><a href="#" style="color: black;text-decoration: none;">QUẢN TRỊ KHÁCH SẠN</a></h3>
                </div>
            </div>
        </div>
        <div class="row">

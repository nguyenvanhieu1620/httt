<%-- 
    Document   : TinhCach3
    Created on : Nov 28, 2023, 3:57:53 PM
    Author     : OS
--%>
...
<html>
    ...
    <body>
        ...
        <section class="intro">
            <div class="container">
                <div class="intro__content">
                    <img src="./Asset/image/Sangtao.jpg" alt="Large Image" class="intro__image">
                    <h3 class="intro__title">Bạn thuộc nhóm người thích sáng tạo</h3>
                    <p class="intro__text">
                        Những người thuộc nhóm Sáng tạo thích làm việc với ý tưởng và sự sáng tạo. Họ thường được mô tả là cởi mở, sáng tạo, độc đáo, nhạy cảm, bốc đồng và khác biệt. Họ không thích tuân theo các quy tắc và luật lệ hay làm các công việc lặp đi lặp lại, mà có hứng thú với các công việc có tính mới mẻ, cần vận dụng khả năng sáng tạo để giải quyết vấn đề hay tạo ra sản phẩm. Do vậy họ thường cảm thấy hứng thú và bị thu hút với các lĩnh vực nghệ thuật, văn hóa, thẩm mỹ...
        ...
        <section class="featured-destinations">
            <div class="container">
                <h2 class="featured-destinations__title">CAO ĐẲNG VĂN HÓA NGHỆ THUẬT</h2>
                <hr class="divider">
                <div class="row">
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/DienXuat.jpg" alt="Destination 1" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">ĐIỆN ẢNH</a></h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/AmNhac.jpg" alt="Destination 2" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">ÂM NHẠC</a></h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/BaoChi.jpg" alt="Destination 3" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">BÁO CHÍ</a></h3>
                        </div>
                    </div>
                </div>
                <div class="row">

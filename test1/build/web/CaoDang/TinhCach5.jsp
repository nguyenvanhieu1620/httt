...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="intro__content">
                    ...
                    <p class="intro__text">
                        ...
                        Dưới đây là gợi ý các trường Cao đẳng học và ngành học phù hợp với bạn:
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="featured-destinations">
            <div class="container">
                <h2 class="featured-destinations__title">CAO ĐẲNG TÀI CHÍNH NGÂN HÀNG</h2>
                <hr class="divider">
                <div class="row">
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/TCDN.png" alt="Destination 1" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">TÀI CHÍNH NGÂN HÀNG</a></h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/KTH.jpg" alt="Destination 2" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">TÀI CHÍNH</a></h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="destination">
                            <img src="./Asset/image/TTQT.png" alt="Destination 3" class="destination__image">
                            <h3 class="destination__title"><a href="#" style="color: black; text-decoration: none;">TÀI CHÍNH QUỐC TẾ</a></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
